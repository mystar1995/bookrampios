...
//=== screen ===
class WriterMainHomeScreen extends Component {
  constructor(props){
    super(props)
    this.state={
      ...
      category:props.route.params?props.route.params:{}
    }
  }
  ...
  componentDidMount()
  {
    this.props.navigation.addListener('focus',payload=>{
      let index = this.props.route.params?this.props.route.params.index:0;
            ...
            switch (route.key) {
              case 'writerHome':
                return <WriterHomeScreen 
                        drawer={this._drawer}
                        tabconvert ={(page)=>this.setState({index:page})}
